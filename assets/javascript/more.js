...
$("#boz-more").click(function(){
  ...
  $("#mag-more").click(function() {
    ...
    if(isClicked) {
      ...
      $("#mag-text").show(200);
      $("#mag-text").text("Adw. Magdalena Niewiadomska-Wojcieszek ukończyła z wynikiem bardzo dobrym studia na kierunku prawo na Wydziale Prawa i Administracji Uniwersytetu Łódzkiego. Podczas studiów otrzymała dwukrotnie list gratulacyjny od Rektora UŁ za bardzo dobre wyniki w nauce. W tym okresie odbywała praktyki w łódzkich kancelariach adwokackich. Następie rozpoczęła aplikację adwokacką w Okręgowej Radzie Adwokackiej w Łodzi pod patronatem adw. Bożeny Niecieckiej – Ostojskiej, którą zakończyła zdając egzamin adwokacki w 2015 r. Okres aplikacji zaowocował zdobyciem cennego doświadczenia teoretycznego jak i praktycznego niezbędnego w pracy adwokata. Adw. Magdalena Niewiadomska – Wojcieszek odbyła również studia doktoranckie będąc doktorantem w Katedrze Zbiorowego i Europejskiego Prawa Pracy Uniwersytetu Łódzkiego. Od początku kariery zawodowej związana z prawem rodzinnym. Nieustannie poszerza swoją wiedzę uczestnicząc w licznych szkoleniach. W 2018 r. ukończyła z wynikiem bardzo dobrym studia podyplomowe prowadzone na Uniwersytecie Łódzkim – „Prawo rodzinne z elementami psychologii”. Włada językiem angielskim i niemieckim.");
